...
//burger
      function addListeners(){
        ...
        pickups[i].addEventListener("click", async function(evt){ //pickups is een array met alle elementen die als class "pickup" hebben
          ...
          if(pickups[i].id == "burger" && j == 1){
            ...
            document.getElementById("tv").setAttribute("text", "value:Lekker bezig!; color: black; align: center;color: black; align: center;")
            await sleep(1000);
            document.getElementById("tv").setAttribute("text", "value: Tijd om het broodje te snijden; color: black; align: center;color: black; align: center;")
            j++;
         }
          ...
          if(pickups[i].id == "broodje" && j == 3){
            ...
            document.getElementById("tv").setAttribute("text", "value: Leg hem nu maar op het bord; color: black; align: center;color: black; align: center;")
            j++
          }
          ...
          if(pickups[i].id == "slablaadje" && j == 6){
            ...
            document.getElementById("tv").setAttribute("text", "value: Tijd om de tomaat te snijden; color: black; align: center;color: black; align: center;")
            j++;
            ...
            document.getElementById("spotlight").setAttribute("light", "type: spot; intensity: 0.3; angle: 3; target: #burger;")
            document.getElementById("tv").setAttribute("text", "value: Nu is de burger klaar met bakken\nhij kan dus ook het broodje op; color: black; align: center;color: black; align: center;")
            await sleep(5000)
      ...
      async function television(){
        if(j==0){
          ...
          document.getElementById("spotlight").setAttribute("light", "type: spot; intensity: 0.3; angle: 3; target: #olie;")
        }
      }
      television();
      addListeners();
